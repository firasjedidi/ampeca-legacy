...
USE ampeca
CREATE TABLE user (id int AUTO_INCREMENT ,username varchar (200), email varchar(200) , password varchar(225),last_login datetime,UNIQUE KEY email (email), PRIMARY KEY (id))ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci; ; 
